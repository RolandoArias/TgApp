...
const CardProductInfo = ({idproduct, name, price, image, isFavorite = false, lang = "es", ...props}) => {
            ...
            <View style={ styles.footercard } > 
                <View style={ styles.buyproduct } >
                    ...
                    <View style={ styles.rightlad} >
                        <ButtonComponent text={ TranslateText(lang, 'Agregar producto') } iconName="" Action={AddProductToCar} />
                    </View>
                </View>
            </View>
        </View>
