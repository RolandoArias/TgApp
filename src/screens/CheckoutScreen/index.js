                ...
                <View style={ styles.containerScroll} >
                    <AnimatedScrollView 
                        ...
                        contentContainerStyle={styles.contentContainer} >
                            ...
                            { 
                                userToken && 
                                <Carretilla lang={lang} 
                                    userToken={userToken} navigation={navigation} 
                                    changeTotal={changeTotal} cart={cart} handleDrop={handleDrop}
                            ...
                            { updateCheckout && <ModalsCheckout navigation={navigation} CloseModal={CloseModal} isUpdateCheckout /> }
                            { removeCheckout && <ModalsCheckout navigation={navigation} CloseModal={CloseModal} isDropCheckout /> }
                        
                    </AnimatedScrollView>
                </View>

                <View style={ styles.containerBottom } >
                    <ButtonCarritoComponent color="blue" text={TranslateText(lang, "Procesar compra")} alternText={totalPrice} iconName="arrowright" Action={ToPurchasing} />
                </View>
