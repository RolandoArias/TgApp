    ...
    return (
        <SafeAreaView style={styles.container} >
            <View style={styles.viewProduct} >
                ...
                {   !loading && userToken 
                    && data.is_favorite 
                    && <CardProductInfo idproduct={itemProduct} name={data.name} 
                            price={data.unit_price} image={data.images[0].url} updatingCheckout={updatingCheckout} 
                            lang={lang} isFavorite /> 
                }
                {   !loading && userToken 
                    && !data.is_favorite 
                    && <CardProductInfo idproduct={itemProduct} name={data.name} 
